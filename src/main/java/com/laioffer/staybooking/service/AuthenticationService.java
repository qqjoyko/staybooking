...
@Service
public class AuthenticationService {//验证用户身份并生成token
    private AuthenticationManager authenticationManager;//验证用户名密码
    private AuthorityRepository authorityRepository;//用户是host还是guest
